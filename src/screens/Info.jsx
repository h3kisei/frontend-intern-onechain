      ...
      <div className="sub-maini">
        <div className="sub-maini1">
          ...
          <div>
            ...
            {!!errors?.sex && <div className="errors">{errors?.sex}</div>}
            <Input
              mt="15px"
            ...
            />
            {!!errors?.birth && <div className="errors">{errors?.birth}</div>}
            <Input
            ...
            />
            {!!errors?.level && <div className="errors">{errors?.level}</div>}
            <Input
            ...
            <div className="image">
              <input type="file" name="myImage" ref={inputAvatarRef} />
            </div>
            <Button
              colorScheme="blue"
              mt="20px"
